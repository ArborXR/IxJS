...
function I(){return function(a){return new H(a[Symbol.asyncIterator](),new da)}};class ha extends E{constructor(a,b){super();this.g=a;this.I=b}[Symbol.asyncIterator](){return this.g[Symbol.asyncIterator](this.I)}}function J(a,b){return b?new ha(a,b):a};async function K(a){"function"===typeof a.return&&await a.return()};class L extends E{constructor(a){super();this.g=a}async*[Symbol.asyncIterator](a){x(a);let b=null,c=!1;for(const d of this.g){const e=J(d,a)[Symbol.asyncIterator]();b=null;for(c=!1;;){let f={};try{const {done:h,value:k}=await e.next();if(h){await K(e);break}f=k}catch(h){b=h;c=!0;await K(e);break}yield f}if(!c)break}if(c)throw b;}};function M(a){return null===a||"object"!==typeof a&&"function"!==typeof a}const N=new WeakMap;
function O(a){let b;return(new Promise((c,d)=>{b={resolve:c,reject:d};for(const e of a){if(M(e)){Promise.resolve(e).then(c,d);continue}let f=N.get(e);void 0===f?(f={m:new Set([b]),L:!1},N.set(e,f),Promise.resolve(e).then(h=>{for(const {resolve:k}of f.m)k(h);f.m.clear();f.L=!0},h=>{for(const {reject:k}of f.m)k(h);f.m.clear();f.L=!0})):f.L?Promise.resolve(e).then(c,d):f.m.add(b)}})).finally(()=>{for(const c of a)M(c)||N.get(c).m.delete(b)})};const ia=new Promise(()=>{});function P(a,b){return a.then(c=>({value:c,index:b}))}
class Q extends E{constructor(a){super();this.l=a}async*[Symbol.asyncIterator](a){x(a);const b=this.l.length,c=Array(b),d=Array(b);let e=!1;const f=Array(b),h=Array(b);let k=b;h.fill(!1);for(let m=0;m<b;m++){const r=J(this.l[m],a)[Symbol.asyncIterator]();c[m]=r;d[m]=P(r.next(),m)}for(;0<k;){a=O(d);const {value:{value:m,done:r},index:v}=await a;if(r)d[v]=ia,k--;else if(f[v]=m,h[v]=!0,d[v]=P(c[v].next(),v),e||=h.every(l))yield f}}};class R extends E{constructor(a){super();this.g=a}async*[Symbol.asyncIterator](a){x(a);for(const b of this.g)for await(const c of J(b,a))yield c}};class ja extends E{constructor(a){super();this.D=a}async*[Symbol.asyncIterator](a){x(a);const b=await this.D(a);for await(const c of J(b,a))yield c}}function ka(a){return new ja(a)};class la extends E{async*[Symbol.asyncIterator](a){x(a)}}function ma(){return new la};const na=new Promise(()=>{});function oa(a,b){return a.then(c=>({value:c,index:b}))};const pa="undefined"!==typeof SharedArrayBuffer?SharedArrayBuffer:ArrayBuffer;class S extends E{constructor(a){super();this.O=a}[Symbol.asyncIterator](){const a=this.O,b=a.getReader();return qa(a,b,ra(b))}}class sa extends S{[Symbol.asyncIterator](){var a=this.O;let b;try{b=a.getReader({mode:"byob"})}catch(c){return super[Symbol.asyncIterator]()}a=qa(a,b,ta(b));a.next();return a}}
...
Z.forkJoin=async function(...a){let b=a.shift();b instanceof AbortSignal||(a.unshift(b),b=void 0);const c=a.length,d=Array(c),e=Array(c);let f=c;const h=Array(c),k=Array(c);k.fill(!1);for(let m=0;m<c;m++){const r=J(a[m],b)[Symbol.asyncIterator]();d[m]=r;e[m]=oa(r.next(),m)}for(;0<f;){a=O(e);const {value:m,index:r}=await a;m.done?(e[r]=na,f--):(e[r]=oa(d[r].next(),r),k[r]=!0,h[r]=m.value)}if(0<k.length&&k.every(l))return h};Z.fromDOMStream=T;
...
Z.minBy=function(a,b){const {comparer:c=V,selector:d,signal:e}=b||{};return Ba(a,d,async(f,h)=>-await c(f,h),e)};Z.never=function(){return new Fa};Z.of=function(...a){return new Ga(a)};Z.onErrorResumeNext=function(...a){return new Ha(a)};Z.pipe=function(a,...b){return 0===b.length?a instanceof E?a:y(a):(c=>b.reduce((d,e)=>e(d),c))(a)};Z.race=function(...a){return new Ja(a)};Z.range=function(a,b){return new Ka(a,b)};
Z.reduce=async function(a,b){const {seed:c,signal:d,callback:e}=b;b=b.hasOwnProperty("seed");x(d);let f=0,h=!1,k=c;for await(const m of J(a,d))(h||=b)?k=await e(k,m,f++,d):(k=m,h=!0,f++);if(!b&&!h)throw Error("Sequence contains no elements");return k};
Z.reduceRight=async function(a,b){const {seed:c,signal:d,callback:e}=b;b=b.hasOwnProperty("seed");x(d);a=await La(a,d);let f=!1,h=c;for(let k=a.length-1;0<=k;k--){const m=a[k];(f||=b)?h=await e(h,m,k,d):(h=m,f=!0)}if(!b&&!f)throw Error("Sequence contains no elements");return h};Z.repeatValue=function(a,b=-1){return new Ma(a,b)};
